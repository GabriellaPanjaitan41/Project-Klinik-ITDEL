                        ...
                        <div class="min-w-150px mt-10 text-end">
                            <?php if($data->id): ?>
                                <button id="tombol_simpan"
                                    onclick="handle_save('#tombol_simpan','#form_input','<?php echo e(route('medicine.update', $data->id)); ?>','PATCH', 'Simpan');"
                                    class="btn btn-sm btn-primary">Simpan</button>
                            <?php else: ?>
                                <button id="tombol_simpan"
                                    onclick="handle_save('#tombol_simpan','#form_input','<?php echo e(route('medicine.store')); ?>','POST', 'Simpan');"
                                    class="btn btn-sm btn-primary">Simpan</button>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\klinik\klinik\resources\views/pages/medicine/input.blade.php ENDPATH**/ ?>