                                    ...
                                    <div class="btn-group me-3" role="group">
                                        ...
                                        <div class="dropdown-menu menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-bold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="javascript:;"
                                                    onclick="handle_open_modal('<?php echo e(route('medicine.input_export_pdf')); ?>','#modalListResult','#contentListResult');"
                                                    class="menu-link px-3">PDF</a>
                                            </div>
                                            <div class="menu-item px-3">
                                                <a href="javascript:;"
                                                    onclick="handle_open_modal('<?php echo e(route('medicine.input_export_excel')); ?>','#modalListResult','#contentListResult');"
                                                    class="menu-link px-3">Excel</a>
                                            </div>
                                        </div>
                                    </div>
                                    <button type="button" onclick="load_input('<?php echo e(route('medicine.create')); ?>');"
            ...
            if (ids.length > 0) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('medicine.delete_all')); ?>',
                            type: 'POST',
                            data: {
                                ids: ids,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\klinik\resources\views/pages/medicine/main.blade.php ENDPATH**/ ?>