...
<div class="modal-body">
    <form id="form_input_modal" action="<?php echo e(route('medicine.pdf')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="row">
...
unset($__errorArgs, $__bag); ?>">
                        ...
                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($item->year . '-' . $item->month); ?>"><?php echo e($item->year . '-' . $item->month); ?>
...
<?php /**PATH D:\laragon\www\klinik\resources\views/pages/medicine/input_export_pdf.blade.php ENDPATH**/ ?>