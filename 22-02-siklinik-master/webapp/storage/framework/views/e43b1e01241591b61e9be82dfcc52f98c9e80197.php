                ...
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <h6>Data Rekam Medis <?php echo e($patient->name); ?></h6>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end">
                                <a target="_blank" href="<?php echo e(route('patient.pdf', $patient->id)); ?>"
                                    class="btn btn-sm btn-primary me-2">Cetak PDF</a>
                                <a href="<?php echo e(route('patient.index')); ?>" class="btn btn-sm btn-primary">Kembali</a>
                            </div>
                        </div>
                    </div>
                    <form id="content_filter">
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                <div class="d-flex justify-content-end">
                                    <button type="button"
                                        onclick="load_input('<?php echo e(route('patient.medical_record.create', $patient->id)); ?>');"
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                serverSide: true,
                ajax: '<?php echo e(route('patient.medical_record', $patient->id)); ?>',
                columns: [{
                        data: 'DT_RowIndex',
                        defaultContent: '',
                        orderable: false,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\klinik\resources\views/pages/medicalRecord/main.blade.php ENDPATH**/ ?>