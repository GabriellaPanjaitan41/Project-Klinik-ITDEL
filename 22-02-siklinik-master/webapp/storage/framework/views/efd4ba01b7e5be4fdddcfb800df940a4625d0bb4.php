<div id="kt_header" style="" class="header align-items-stretch">
    ...
    <div class="header-brand">
        <!--begin::Logo-->
        <a href="javascript:;">
            <img alt="Logo" src="<?php echo e(asset('img/favicon.png')); ?>" class="h-25px h-lg-25px" />
        </a>
        <!--end::Logo-->
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px"
                                ...
                                <div class="d-flex flex-column bgi-no-repeat rounded-top"
                                    style="background-image:url('<?php echo e(asset('keenthemes/media/patterns/pattern-1.jpg')); ?>')">
...
<?php /**PATH C:\xampp\htdocs\klinik\klinik\resources\views/layouts/header.blade.php ENDPATH**/ ?>