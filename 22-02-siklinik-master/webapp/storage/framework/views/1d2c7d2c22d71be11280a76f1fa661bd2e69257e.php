...
<script>
    localStorage.setItem("route_counter_notif", "<?php echo e(route('counter_notif')); ?>");
    localStorage.setItem("route_notification", "<?php echo e(route('notification')); ?>");
</script>
...
<?php /**PATH C:\xampp\htdocs\klinik\klinik\resources\views/layouts/js.blade.php ENDPATH**/ ?>