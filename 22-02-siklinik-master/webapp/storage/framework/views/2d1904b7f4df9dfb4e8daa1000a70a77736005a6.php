    ...
    <script>
        $(document).ready(function() {
            $('#table_medicine').DataTable({
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.medicine')); ?>',
                columns: [{
                        data: 'name',
                        name: 'name'
                    },
            ...
            $('#table_patient').DataTable({
                serverSide: true,
                ajax: '<?php echo e(route('dashboard.patient')); ?>',
                columns: [{
                        data: 'name',
                        name: 'name'
                    },
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\klinik\klinik\resources\views/pages/dashboard/main.blade.php ENDPATH**/ ?>